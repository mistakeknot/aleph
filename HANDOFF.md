...
- Current CI at handoff: focused local checks pass; PR gates pass and the full head matrix is queued or running. Follow the [live PR checks](https://github.com/get-bb/bb/pull/4078/checks).
